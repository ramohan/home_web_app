...
String.prototype.parseURL = function () {
	if (typeof this !== "string") {
		console.log("Weird error with stupid prototype munging timeline library.");
		var err = new Error();
...
function Timeline(h, p, r) {
    ...
    this._month_translation = "January February March April May June July August September October November December".split(" ");
    ...
    this._render = function (b, d) {
        ...
        $(b).each(function (b, m) {
            ...
            10 > l && (l = "0" + l);
            var l = n + "-" + l,
                q = !1; - 1 !== $.inArray(n, a._years) || "year" !== a._options.separator && null !== a._options.separator || (q = !0, a._years.push(n)); - 1 !== $.inArray(l, a._months) || "month" !== a._options.separator && "month_year" !== a._options.separator || (q = !0, a._months.push(l));
            var k = "";
